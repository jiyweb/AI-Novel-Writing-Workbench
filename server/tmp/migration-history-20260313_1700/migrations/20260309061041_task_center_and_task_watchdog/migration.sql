-- AlterTable
ALTER TABLE "GenerationJob" ADD COLUMN "cancelRequestedAt" DATETIME;
ALTER TABLE "GenerationJob" ADD COLUMN "currentItemKey" TEXT;
ALTER TABLE "GenerationJob" ADD COLUMN "currentItemLabel" TEXT;
ALTER TABLE "GenerationJob" ADD COLUMN "currentStage" TEXT;
ALTER TABLE "GenerationJob" ADD COLUMN "heartbeatAt" DATETIME;

-- AlterTable
ALTER TABLE "ImageGenerationTask" ADD COLUMN "cancelRequestedAt" DATETIME;
ALTER TABLE "ImageGenerationTask" ADD COLUMN "currentItemKey" TEXT;
ALTER TABLE "ImageGenerationTask" ADD COLUMN "currentItemLabel" TEXT;
ALTER TABLE "ImageGenerationTask" ADD COLUMN "currentStage" TEXT;
ALTER TABLE "ImageGenerationTask" ADD COLUMN "heartbeatAt" DATETIME;
