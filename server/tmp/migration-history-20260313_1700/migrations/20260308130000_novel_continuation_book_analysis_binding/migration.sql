...
INSERT INTO "new_Novel" ("createdAt", "description", "genreId", "id", "outline", "sourceKnowledgeDocumentId", "sourceNovelId", "status", "structuredOutline", "title", "updatedAt", "worldId", "writingMode") SELECT "createdAt", "description", "genreId", "id", "outline", "sourceKnowledgeDocumentId", "sourceNovelId", "status", "structuredOutline", "title", "updatedAt", "worldId", "writingMode" FROM "Novel";
DROP TABLE "Novel";
