...
function DialogSection(props: { icon: ReactNode; title: string; description?: string; children: ReactNode; withDivider?: boolean }) {
  return (
    <div className={props.withDivider ? "space-y-3 border-t border-border/60 pt-5" : "space-y-3"}>
      <div className="space-y-1">
        <div className="flex items-center gap-1.5 text-xs font-semibold text-foreground">{props.icon} {props.title}</div>
        {props.description ? (
